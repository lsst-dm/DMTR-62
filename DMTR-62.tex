...
\setDocAbstract{%
This brief report describes measurements of interest that were carried out for release v15.0 of the Science Pipeline.

In short, the astrometric performance is excellent in comparison to both the per cycle ramps as well as the design level KPMs. The photometric performance is not as good. The inclusion of \texttt{jointcal} in the processing in future cycles will improve photometric performance. Current reprocessing of HSC data using a precursor to \texttt{jointcal} called \texttt{meas\_mosaic} shows significant improvement over single epoch processing.
