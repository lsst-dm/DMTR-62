...
Note also that the photometric performance of the pipelines in the \emph{y} band
is an under estimate of expected delivered performance.  For these tests,
the \emph{y} band data was calibrated with \emph{z} band photometry.  This is due
to the lack of a reference catalog containing \emph{y} band information at this
time.  We believe the numbers are still worth noting in this report as a historical
benchmark to track relative performance.
